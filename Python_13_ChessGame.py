...
"""
Create a chess game that can run on the shell. Have the functionality of undoing a move,
redoing a move, and making a move.
Convert your procedural functions from earlier homeworks into a class called ChessGame.
Check the test cases below for functionality and also play a game of chess from the console to
fully check the program is working
As an optional challenge, you can make a one-player version with the other side using a 
chess engine.
The solution has both a random move engine and a one-move depth chess engine.
"""
...
def testChessGame():
    ...
    assert(game.makeMove(0, 3, 0, 4) == False)
    board = [
        ['♟', '♚', '♟'],
        [' ', '♔', ' '],
        [' ', ' ', '♙'],
